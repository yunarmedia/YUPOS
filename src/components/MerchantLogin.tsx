...
// Stable component identities are critical here. These components must not be declared
// inside MerchantLogin, otherwise React remounts the <input> after every keystroke.

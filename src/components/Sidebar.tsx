...
import { TrendingUp, Receipt, Package, History, Users, Settings, ShieldAlert, LogOut, Briefcase, Scissors, Sparkles, Utensils, Shirt, Wrench, ChevronRight, X, Lock, Eye, EyeOff } from 'lucide-react';

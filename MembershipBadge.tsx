...
export const MembershipBadge: React.FC<MembershipBadgeProps> = ({
  ...
  return (
    <span
      className={`inline-flex items-center font-black tracking-wider uppercase rounded-full select-none
        bg-gradient-to-r from-amber-400 via-yellow-200 to-amber-500 
        text-amber-950 border border-yellow-300 shadow-sm ring-1 ring-amber-400/50 
        relative overflow-hidden ${sizeClasses[size]} ${className}`}
      title="Pelanggan Terdaftar Sebagai Membership"
    >
      ...
      <span className="relative z-10 whitespace-nowrap drop-shadow-2xs">
        Membership Customer
      </span>
